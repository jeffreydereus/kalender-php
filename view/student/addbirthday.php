    ...
    <form name="frmRegistration" method="post" action="<?= URL ?>student/addbd" class="formr">
        <fieldset>
            <legend>Voer hier uw informatie in.</legend>
                ...
                <p>Uw geboorte jaar:
                    <input type="number" style="width: 50px; margin-left: 30px" required min="1900" max="2018" class="demoInputBox" name="Birthyear" value="<?php if(isset($_POST['Birthyear'])) echo $_POST['Birthyear']; ?>"></p>
